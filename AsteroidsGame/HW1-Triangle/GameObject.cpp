...
#pragma region Assimp Loading
// loads a model with supported ASSIMP extensions from file and stores the resulting meshes in the meshes vector.
void GameObject::loadModel(string const &path)
{
...
vector<Texture> GameObject::loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName)
{
	vector<Texture> textures;
...
void GameObject::AveragePosition()
{
